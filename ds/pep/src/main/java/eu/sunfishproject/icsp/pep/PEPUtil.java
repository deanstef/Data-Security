...
public class PEPUtil {
    ...
    public static Response buildHttpResponse(final SunfishHttpObject sunfishHttpObject) {
        ...
        final javax.ws.rs.core.Response.ResponseBuilder
                responseBuilder =
                javax.ws.rs.core.Response.status(sunfishHttpObject.getResponseCode());
...
//        }
    ...
    public static Request buildPDPAuthorization(final SunfishRequest sunfishRequest,
                                                final SunfishService sunfishService,
                                                final SunfishHttpObject sunfishHttpObject,
                                                final UserSession userSession,
                                                final String zone) throws ICSPException, XACMLBuilderException {


        XACMLRequestBuilder
                xacml =
                prepareRequest(sunfishService, zone).setCategory(XACMLConstants.CATEGORY_REQUEST)
                        ...
                        .addStringAttribute(XACMLConstants.ATTRIBUTE_REQUEST_CONTENT_TYPE,
                                sunfishRequest.getContentType());


        if (userSession != null) {
            List<String> userRoles = userSession.getUserRoles();
            xacml =
                    xacml.setCategory(XACMLConstants.CATEGORY_IDENTITY)
        ...
        final String[]
                missingAttributes =
                new String[]{XACMLConstants.ATTRIBUTE_REQUEST_BODY_DATA,
    ...
    private static XACMLRequestBuilder prepareRequest(final SunfishService sunfishService, String zone) throws
                                                                                                        XACMLBuilderException {
        return new XACMLRequestBuilder().setCategory(XACMLConstants.CATEGORY_SERVICE)
    ...
    public static Request buildPDPAuthorization(final SunfishResponse sunfishResponse,
                                                final SunfishService sunfishService,
                                                final SunfishRequest originalRequest,
                                                final SunfishHttpObject sunfishHttpObject,
                                                final UserSession userSession,
                                                String zone) throws ICSPException, XACMLBuilderException {

        XACMLRequestBuilder
                xacml =
                prepareRequest(sunfishService, zone).setCategory(XACMLConstants.CATEGORY_RESPONSE)
                        ...
                        .addStringAttribute(XACMLConstants.ATTRIBUTE_RESPONSE_ENFORCED_ACTION,
                                sunfishResponse.getEnforcedAction());
        ...
        final String[]
                missingAttributes =
                new String[]{XACMLConstants.ATTRIBUTE_RESPONSE_BODY_DATA,
