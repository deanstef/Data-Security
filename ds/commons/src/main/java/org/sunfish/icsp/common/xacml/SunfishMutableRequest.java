 ...
 */
public class SunfishMutableRequest implements Request {
    ...
    private final HashMap<Identifier, List<RequestAttributes>> requestAttributesByCategoryId = new HashMap<Identifier, List<RequestAttributes>>();
    private final HashMap<String, RequestAttributes> requestAttributesByXmlId = new HashMap<String, RequestAttributes>();
    private List<RequestReference> requestReferences;

    /**
     * Creates a new <code>SunfishMutableRequest</code> with the given parameters.
     *
     * @param statusIn the {@link org.apache.openaz.xacml.api.Status} of the <code>SunfishMutableRequest</code>
     ...
     */
    public SunfishMutableRequest(Status statusIn, RequestDefaults requestDefaultsIn,
    ...
    /**
     * Creates a new <code>SunfishMutableRequest</code> with a default {@link org.apache.openaz.xacml.api.Status} and the given parameters.  The default <code>Status</code>
     ...
     */
    public SunfishMutableRequest(RequestDefaults requestDefaultsIn, boolean returnPolicyIdListIn,
    ...
    /**
     * Creates a new <code>SunfishMutableRequest</code> that is a copy of the given {@link org.apache.openaz.xacml.api.Request}.
     *
     * @param request the <code>Request</code> to copy
     */
    public SunfishMutableRequest(Request request) {
    ...
    /**
     * Creates a new <code>SunfishMutableRequest</code> with default values.
     */
    public SunfishMutableRequest() {
        this(null, false, false, null, null);
    }

    /**
     * Creates a new <code>SunfishMutableRequest</code> with the given {@link org.apache.openaz.xacml.api.Status} representing its validity and
     * defaults for all other attributes.
     *
     * @param statusIn the <code>Status</code> for the new <code>SunfishMutableRequest</code>
     */
    public SunfishMutableRequest(Status statusIn) {
    ...
    /**
     * Adds a {@link org.apache.openaz.xacml.api.RequestAttributes} to the <code>RequestAttributes</code> in this <code>SunfishMutableRequest</code>>
     *
     * @param requestAttributesNew the <code>RequestAttributes</code> to add to this
     *            <code>SunfishMutableRequest</code>
    ...
    /*
    * Added in order to provide remove functionality
    */
    public void remove(RequestAttributes requestAttributes) {
        this.requestAttributes.remove(requestAttributes);
    }
    ...
    /**
     * Adds a {@link org.apache.openaz.xacml.api.RequestReference} to the <code>RequestReference</code>s in this <code>SunfishMutableRequest</code>.
     *
    ...
    /**
     * Sets the {@link org.apache.openaz.xacml.api.Status} indicating the validity of this <code>SunfishMutableRequest</code>.
     *
     * @param statusIn the <code>Status</code> for this <code>SunfishMutableRequest</code>.
     */
