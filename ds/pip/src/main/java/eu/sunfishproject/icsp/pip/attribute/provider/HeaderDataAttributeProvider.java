 ...
 */
public class HeaderDataAttributeProvider implements AttributeProvider {
    ...
    public boolean supportsAttribute(final AttributeDesignator attribute) {
        return attribute.getCategory().stringValue().equals(XACMLConstants.CATEGORY_REQUEST) &&
                attribute.getAttributeId().stringValue().equals(XACMLConstants.ATTRIBUTE_REQUEST_HEADER_PARAMETER) &&
    ...
    public List<AttributeValue> getValuesForAttribute(final AttributeDesignator attribute, final Request request) {
        ...
        attributeValues.add(XACMLUtils.createStringAttributeValue("sfhp021"));
        attributeValues.add(XACMLUtils.createStringAttributeValue("sfhp101"));
