...
public abstract class DOMPolicyDef {
    ...
    public static PolicyDef newInstance(final Document document, final PolicySet policySetParent)
      ...
      PolicyDef policyDef = null;
        try {
            ...
            policyDef = readPolicyDef(rootNode, policySetParent);
    ...
    public static PolicyDef readPolicyDef(final Node rootNode,final PolicySet policySetParent) throws DOMStructureException {
      PolicyDef policyDef;
    ...
    public static PolicyDef load(final InputStream inputStream) throws DOMStructureException {
        PolicyDef policyDef = null;
        try {
            final Document document = DOMUtil.loadDocument(inputStream);
            if (document == null) {
     ...
     */
    public static PolicyDef load(final File filePolicy) throws DOMStructureException {
        /*
         * Parse the XML file
         */
        PolicyDef policyDef = null;
        try {
            final Document document = DOMUtil.loadDocument(filePolicy);
            if (document == null) {
                throw new DOMStructureException("Null document returned");
            }
            policyDef = newInstance(document, null);
