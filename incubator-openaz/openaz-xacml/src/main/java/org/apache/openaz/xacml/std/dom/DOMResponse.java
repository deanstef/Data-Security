...
public class DOMResponse {
     ...
     */
    public static Response newInstance(final Node nodeResponse) throws DOMStructureException {
        final Element elementResponse = DOMUtil.getElement(nodeResponse);
        final boolean bLenient = DOMProperties.isLenient();

        final StdMutableResponse mutableResponse = new StdMutableResponse();

        final NodeList children = elementResponse.getChildNodes();
        int numChildren;
     ...
     */
    public static boolean repair(final Node nodeResponse) throws DOMStructureException {
        final Element elementResponse = DOMUtil.getElement(nodeResponse);
    ...
    public static Response load(final String xmlString) throws DOMStructureException {
     ...
     * @throws DOMStructureException
     */
    public static Response load(final File fileResponse) throws DOMStructureException {
     ...
     * @throws DOMStructureException
     */
    public static Response load(final Path fileResponse) throws DOMStructureException {
        try {
     ...
     * @throws DOMStructureException
     */
    public static Response load(final InputStream is) throws DOMStructureException {
        Response request = null;
        try {
            final Document document = DOMUtil.loadDocument(is);
            if (document == null) {
     ...
     * @throws Exception
     */
    public static String toString(final Response response) throws Exception {
     ...
     * @throws Exception
     */
    public static String toString(final Response response, final boolean prettyPrint) throws Exception {
     ...
     * @param prettyPrint
     */
    private static void outputStatusCode(final StringBuilder sb, final StatusCode statusCode, final int tabCount,
     ...
     * @throws DOMStructureException
     */
    private static String outputValueValue(final Object obj) throws DOMStructureException {
        if (obj instanceof String || obj instanceof Boolean || obj instanceof Integer
            ...
            final XPathExpressionWrapper xw = (XPathExpressionWrapper)obj;
     ...
     * @return
     */
    private static String getNamespaces(final Object valueObject) {
        String returnString = "";
        if (!(valueObject instanceof XPathExpressionWrapper)) {
            // value is not XPathExpression, so has no Namespace info in it
            return returnString;
        }
        final XPathExpressionWrapper xw = (XPathExpressionWrapper)valueObject;

        final ExtendedNamespaceContext namespaceContext = xw.getNamespaceContext();
        if (namespaceContext != null) {
            // get the list of all namespace prefixes
            final Iterator<String> prefixIt = namespaceContext.getAllPrefixes();
            while (prefixIt.hasNext()) {
                final String prefix = prefixIt.next();
     ...
     * @throws DOMStructureException
     */
    public static void convert(final Response response, final OutputStream outputStream) throws IOException,
     ...
     * @throws DOMStructureException
     */
    public static void convert(final Response response, final OutputStream outputStream, final boolean prettyPrint)
        ...
        for (final Result result : response.getResults()) {
            ...
            if (status != null) {
                ...
                if (statusDetail != null) {
                    ...
                    if (result.getStatus().getStatusDetail().getMissingAttributeDetails() != null) {
                        ...
                        for (final MissingAttributeDetail mad : statusDetail.getMissingAttributeDetails()) {
                            ...
                            sb.append(" ").append(XACML3.ATTRIBUTE_CATEGORY).append("=\"").append( mad.getCategory().stringValue() + "\"");
                            sb.append(" ").append(XACML3.ATTRIBUTE_ATTRIBUTEID).append("=\"" ).append( mad.getAttributeId().stringValue() + "\"");
                            sb.append(" ").append(XACML3.ATTRIBUTE_DATATYPE).append("=\"" ).append( mad.getDataTypeId().stringValue() + "\"");
                            if (mad.getIssuer() != null) {
                                sb.append(" ").append(XACML3.ATTRIBUTE_ISSUER).append("=\"" ).append( mad.getIssuer() + "\"");
                            }
                            sb.append(">");
                            if (mad.getAttributeValues() != null) {
                                for (final AttributeValue<?> value : mad.getAttributeValues()) {
                                    if (prettyPrint) {
                                        sb.append("\n\t\t\t\t\t");
                                    }
            ...
            if (result.getObligations() != null && result.getObligations().size() > 0) {
                ...
                for (final Obligation obligation : result.getObligations()) {
                    ...
                    for (final AttributeAssignment aa : obligation.getAttributeAssignments()) {
                        if (prettyPrint) {
                          sb.append("\n\t\t\t\t");
                        }
                        ...
                        if (aa.getCategory() != null) {
                            sb.append(" Category=\"").append(aa.getCategory().stringValue()).append("\"");
                        }
                        sb.append(getNamespaces(aa.getAttributeValue().getValue()) + ">");
            ...
            if (result.getAssociatedAdvice() != null && result.getAssociatedAdvice().size() > 0) {
                ...
                for (final Advice advice : result.getAssociatedAdvice()) {
                    ...
                    for (final AttributeAssignment aa : advice.getAttributeAssignments()) {
                        if (prettyPrint) {
                          sb.append("\n\t\t\t\t");
                        }
                        sb.append("<AttributeAssignment");
            ...
            if (result.getAttributes() != null && result.getAttributes().size() > 0) {
                ...
                for (final AttributeCategory category : result.getAttributes()) {
                    if (prettyPrint) {
                      sb.append("\n\t\t");
                    }
                    ...
                    for (final Attribute attr : category.getAttributes()) {
                        ...
                        for (final AttributeValue<?> value : attr.getValues()) {
            ...
            final Collection<IdReference> policyIds = result.getPolicyIdentifiers();
            final Collection<IdReference> policySetIds = result.getPolicySetIdentifiers();
            if (policyIds != null && policyIds.size() > 0 || policySetIds != null && policySetIds.size() > 0) {
                ...
                // individual Ids
                for (final IdReference idReference : policyIds) {
                    if (idReference == null) {
                ...
                // Set Ids
                for (final IdReference idReference : policySetIds) {
                    if (idReference == null) {
    ...
    public static void main(final String[] args) {
        if (args.length > 0) {
            for (final String xmlFileName : args) {
                final File fileXml = new File(xmlFileName);
                if (!fileXml.exists()) {
                ...
                try {
                    final Document documentResponse = DOMUtil.loadDocument(fileXml);
                    assert documentResponse != null;

                    final NodeList children = documentResponse.getChildNodes();
